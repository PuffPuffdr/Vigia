...
export default function WhatsappButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_28px_rgba(37,211,102,0.45)] transition-transform duration-300 ease-smooth hover:scale-105 active:scale-95 sm:bottom-8 sm:right-8 relative"
    >
      <span
